...
# Common SVG attributes that are case-sensitive and might be lowercased by the parser.
# We map the lowercase version back to the correct camelCase version.
SVG_CASE_FIX = {
...
# Common SVG tags that are mixed case and might be lowercased by the parser.
SVG_TAG_FIX = {
    "altglyph": "altGlyph",
